...
import { dataLine, dataBar, dataPie, dataRadar } from '../assets/chartData';
...
ChartJS.register(LineElement, BarElement, CategoryScale, LinearScale, PointElement, ArcElement, Tooltip, Legend, RadialLinearScale);
  ...
  return (
    <div className="grow p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white p-4 dark:bg-gray-800 rounded-lg shadow-md">
          <h3 className="text-lg font-semibold mb-4">Athlete Performance</h3>
